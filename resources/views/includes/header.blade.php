        ...
        <div class="header-menu-ctn">
            ...
            <button id="profileButton">
                ...
                <div class="profile-button-menu" id="profileButtonMenu">
                    <a href="{{asset('/profile')}}" class="profile-button-menu-item" style="border-radius:3px 3px 0px 0px;">
                    ...
                    <a href="{{asset('/saved-posts')}}" class="profile-button-menu-item">
                    ...
                    <a href="{{asset('/config')}}" class="profile-button-menu-item">
