        ...
        <div class="profile">
            <div class="profile-header">
                <div class="profile-picture-ctn">
                    <img src="{{asset(Auth::user()->user_profile_image_url)}}">
                </div>
                <div class="profile-info-ctn">
                    <div class="profile-info-wrapper">
                        ...
                        <span class="profile-info-user-full-name">{{Auth::user()->name}}</span>
                        <span class="profile-info-user-bio">{{Auth::user()->biography}}</span>
                        <a class="profile-info-website-link" href="{{Auth::user()->site}}">{{Auth::user()->site}}</a>
                    </div>
                </div>
                <div class="profile-upload-ctn">
                    <div class="profile-upload-wrapper">
                        ...
                        <svg style="enable-background:new 0 0 48 48;width:100px;" version="1.1" viewBox="0 0 48 48" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g class="st0" id="Padding__x26__Artboard"/><g id="Icons">
                            <path class="st1" d="M30.1311,35.0978H17.8689c-2.74303,0-4.9667-2.22366-4.9667-4.9667V17.8689   c0-2.74303,2.22367-4.9667,4.9667-4.9667H30.1311c2.74303,0,4.9667,2.22367,4.9667,4.9667V30.1311   C35.0978,32.87414,32.87414,35.0978,30.1311,35.0978z"/><g>
                            <line class="st1" x1="24" x2="24" y1="20.14733" y2="27.85267"/><line class="st1" x1="20.14733" x2="27.85267" y1="24" y2="24"/></g></g>
                        </svg>
